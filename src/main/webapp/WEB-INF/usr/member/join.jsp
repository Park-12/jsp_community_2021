...
<script>
	...
	function MemberJoin__checkValidLoginId(el) {
		...
		$.get("../member/getCheckValidLoginId", {
          ...
          <div class="form-control">
            ...
            <div>
              <input
                ...
                onchange="MemberJoin__checkValidLoginId(this)"
                onkeyup="MemberJoin__checkValidLoginId(this)" />
